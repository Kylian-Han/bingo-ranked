...
execute unless entity @a[tag=compass_closest] as @a[tag=compass_hunter] if predicate flytre:holding_compass run title @s actionbar ["",{"text":"Nearest Runner: ","color":"white"},{"text":"N/A","color":"red"}]
