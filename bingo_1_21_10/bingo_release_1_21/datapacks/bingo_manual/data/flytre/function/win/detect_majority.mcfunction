...
execute if score red majority matches ..0 run function ranked:on_win_red
...
execute if score yellow majority matches ..0 run function ranked:on_win_yellow
...
execute if score green majority matches ..0 run function ranked:on_win_green
...
execute if score blue majority matches ..0 run function ranked:on_win_blue
