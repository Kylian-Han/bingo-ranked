...
tag @a[team=] add noTeam
execute if score teams stage matches 2 run scoreboard players operation us teamScore = @s teamScore
execute if score teams stage matches 2 as @s[team=red] run scoreboard players operation them teamScore = @p[team=!red, tag=!noTeam] teamScore
execute if score teams stage matches 2 as @s[team=yellow] run scoreboard players operation them teamScore = @p[team=!yellow, tag=!noTeam] teamScore
execute if score teams stage matches 2 as @s[team=green] run scoreboard players operation them teamScore = @p[team=!green, tag=!noTeam] teamScore
execute if score teams stage matches 2 as @s[team=blue] run scoreboard players operation them teamScore = @p[team=!blue, tag=!noTeam] teamScore
