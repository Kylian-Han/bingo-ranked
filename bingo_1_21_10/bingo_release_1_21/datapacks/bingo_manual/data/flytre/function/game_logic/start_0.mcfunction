...
item replace entity @a[gamemode=!spectator] hotbar.0 with minecraft:filled_map[custom_name={"text":"Bingo Board","color":"dark_red","italic":false},map_id=1] 1
item replace entity @a[gamemode=!spectator] hotbar.1 with minecraft:filled_map[custom_name={"text":"Bingo Board","color":"dark_red","italic":false},map_id=1] 1
item replace entity @a[gamemode=!spectator] hotbar.2 with minecraft:filled_map[custom_name={"text":"Bingo Board","color":"dark_red","italic":false},map_id=1] 1
item replace entity @a[gamemode=!spectator] hotbar.3 with minecraft:filled_map[custom_name={"text":"Bingo Board","color":"dark_red","italic":false},map_id=1] 1
item replace entity @a[gamemode=!spectator] hotbar.4 with minecraft:filled_map[custom_name={"text":"Bingo Board","color":"dark_red","italic":false},map_id=1] 1
item replace entity @a[gamemode=!spectator] hotbar.5 with minecraft:filled_map[custom_name={"text":"Bingo Board","color":"dark_red","italic":false},map_id=1] 1
item replace entity @a[gamemode=!spectator] hotbar.6 with minecraft:filled_map[custom_name={"text":"Bingo Board","color":"dark_red","italic":false},map_id=1] 1
item replace entity @a[gamemode=!spectator] hotbar.7 with minecraft:filled_map[custom_name={"text":"Bingo Board","color":"dark_red","italic":false},map_id=1] 1
item replace entity @a[gamemode=!spectator] hotbar.8 with minecraft:filled_map[custom_name={"text":"Bingo Board","color":"dark_red","italic":false},map_id=1] 1
