gamemode adventure @a[gamemode=!adventure,tag=!debug]
...
execute as @a[tag=!init] run give @s filled_map[map_id=1,custom_name={"color":"dark_red","italic":false,"text":"Bingo Board"}] 1
execute as @a[tag=!init] run tp @s 182.5 135 81.0 -90 0
tag @a add init


#team join by stepping on concrete
scoreboard players add anim_timer global 1
execute if score anim_timer global matches 40.. run scoreboard players set anim_timer global 0

scoreboard players add anim_timer global 1
execute if score anim_timer global matches 30.. run scoreboard players set anim_timer global 0

execute as @a[team=] if score anim_timer global matches 0..14 run title @s actionbar {"text":"Step on a pad to join a team!","color":"gold"}
execute as @a[team=] if score anim_timer global matches 15..29 run title @s actionbar {"text":"Step on a pad to join a team!","color":"white"}
execute as @a[team=red] run title @s actionbar {"text":"Team Red","color":"red"}
execute as @a[team=yellow] run title @s actionbar {"text":"Team Yellow","color":"yellow"}
execute as @a[team=green] run title @s actionbar {"text":"Team Green","color":"green"}
execute as @a[team=blue] run title @s actionbar {"text":"Team Blue","color":"aqua"}
