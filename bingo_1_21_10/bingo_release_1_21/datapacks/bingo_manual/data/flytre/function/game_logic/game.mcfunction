...
execute unless score lockout stage matches 1 if score supply_drop_time global matches 1..4800 as @a unless predicate flytre:holding_compass run title @s actionbar ["",{"text":"XYZ: ","color":"yellow"},{"score":{"name":"@s","objective":"compass_tx"}}," ",{"score":{"name":"@s","objective":"compass_ty"}}," ",{"score":{"name":"@s","objective":"compass_tz"}}," | ",{"text":"Supply Drop: ","color":"yellow"},{"score":{"name":"@s","objective":"compass_distance"}},"m"]
...
execute if score tick stage matches 20 unless score lockout stage matches 3 run function flytre:win/detect
execute if score tick stage matches 20 if score lockout stage matches 3 run function flytre:win/detect_blackout
...
#update map
#execute unless score lockout stage matches 2 as @a[scores={drop=1..}] at @s if entity @e[type=item,nbt={Item:{components:{"minecraft:map_id":1}}},distance=..3] run function flytre:game_logic/update_map
#execute if score lockout stage matches 2 if score hunters_released stage matches 1 as @a[scores={drop=1..}] at @s if entity @e[type=item,nbt={Item:{components:{"minecraft:map_id":1}}},distance=..3] run function flytre:game_logic/update_map
#execute if score lockout stage matches 2 unless score hunters_released stage matches 1 as @a[scores={drop=1..},team=!red] at @s if entity @e[type=item,nbt={Item:{components:{"minecraft:map_id":1}}},distance=..3] run function flytre:game_logic/update_map
...
execute as @a[scores={give_map=1..},gamemode=!spectator] run give @s filled_map[map_id=1,custom_name={"color":"dark_red","italic":false,"text":"Bingo Board"}] 8
...
#give items on death
execute if score tools stage matches 1 unless score keepInventory stage matches 1 unless score lockout stage matches 2 run give @a[scores={death=1}] minecraft:stone_sword[custom_data={start:1}]
execute if score tools stage matches 1 unless score keepInventory stage matches 1 unless score lockout stage matches 2 run give @a[scores={death=1}] minecraft:stone_axe[custom_data={start:1},enchantments={"minecraft:efficiency":2}]


execute if score tools stage matches 1 unless score keepInventory stage matches 1 if score lockout stage matches 2 run give @a[scores={death=1},team=!red] minecraft:stone_sword[custom_data={start:1}]
execute if score tools stage matches 1 unless score keepInventory stage matches 1 if score lockout stage matches 2 run give @a[scores={death=1},team=!red] minecraft:stone_axe[custom_data={start:1}]
execute if score tools stage matches 1 unless score keepInventory stage matches 1 if score lockout stage matches 2 run give @a[scores={death=1},team=red] minecraft:wooden_sword[custom_data={start:1}]
execute if score tools stage matches 1 unless score keepInventory stage matches 1 if score lockout stage matches 2 run give @a[scores={death=1},team=red] minecraft:wooden_axe[custom_data={start:1}]
...
execute if score tools stage matches 1 unless score keepInventory stage matches 1 unless score item_set stage matches 2 run give @a[scores={death=1}] minecraft:stone_pickaxe[custom_data={start:1},enchantments={"minecraft:efficiency":2}]
execute if score tools stage matches 1 unless score keepInventory stage matches 1 if score item_set stage matches 2 run give @a[scores={death=1}] minecraft:iron_pickaxe[custom_data={start:1}]
execute if score tools stage matches 1 unless score keepInventory stage matches 1 run give @a[scores={death=1}] minecraft:stone_shovel[custom_data={start:1},enchantments={"minecraft:efficiency":2}]

execute unless score keepInventory stage matches 1 as @a[scores={death=1}] run give @s filled_map[map_id=1,custom_name={"color":"dark_red","italic":false,"text":"Bingo Board"}] 32
execute unless score keepInventory stage matches 1 if score lockout stage matches 2 run item replace entity @a[scores={death=1}] hotbar.8 with minecraft:compass[lodestone_tracker={target:{dimension:"minecraft:overworld",pos:[I;0,64,0]},tracked:false},custom_name={"color":"red","italic":false,"text":"Tracker"},custom_data={tracker:1}]
